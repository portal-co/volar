...
| [mpc-external-actions-oracles-ledger.md](mpc-external-actions-oracles-ledger.md) | Authoritative external-MPC executor/oracle/boundary implementation and evidence ledger |
